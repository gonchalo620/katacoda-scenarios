...
git push https://kyztsenirkho4eehlsxcu6ownvscgzg23rp6dgtrcpwkidwp35xq@dev.azure.com/capacitaciones-azure-devops/Aprendiendo_Git/_git/Aprendiendo_Git "features/merge_$number_random"
sleep 3
git fetch origin
git checkout remotes/origin/master
git merge remotes/origin/"features/merge_$number_random"
git push https://kyztsenirkho4eehlsxcu6ownvscgzg23rp6dgtrcpwkidwp35xq@dev.azure.com/capacitaciones-azure-devops/Aprendiendo_Git/_git/Aprendiendo_Git
sleep 3
git checkout master
git checkout .
